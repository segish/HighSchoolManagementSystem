<?php
$id11 = $_SESSION['uid'];
$sqlmain="SELECT * FROM `parent` WHERE `id`='$id11'";
$run11=mysqli_query($con,$sqlmain);
$data11=mysqli_fetch_assoc($run11);
$fromname=$data11['fname'];
$sql22="SELECT *FROM message WHERE towhich = 'parent' AND toname = '$fromname' ;";
...
?>
            ...
            <div class="form-group mb-0">
                ...
                <div class="popup" id="popup">
                    ...
                    <h2>Thanks for suggestion</h2>
                    <p>you have send the message succssfully <br> please clik ok to exit this page</p>
                    <button name="sendee" type="button" onclick="closepopup1()">OK</button>
                </div>
            </div>
        </form> 
        <?php
...
$dbcon=mysqli_connect($servername,$username,$passcode,$db_name);
    ...
    $insertQ = "INSERT INTO `message`(`fromwhich`, `towhich`, `fromname`, `toname`, `message`) 
        VALUES ('parent','$towhich','$fromname','$toname','$message')";
