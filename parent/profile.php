...
$studid = $row['studid'];
$sqlstud="SELECT * FROM `student` WHERE `ID`='$studid'";
$runstud=mysqli_query($con,$sqlstud);
$rowstud=mysqli_fetch_assoc($runstud);
?>
<html>
	<head>
		<meta charset="UTF-8">
                     ...
                     <div class="profile-header">
                        <div class="row align-items-center">
                           <div class="col-auto profile-image">
                              <a href="#">
                              <img class="rounded-circle" src="../dataimg/<?php echo $row['img']?>" alt="User Image">
                              </a>
                           </div>
                           <div class="col ml-md-n2 profile-user-info">
                              <h4 class="user-name mb-0"><?php echo $row['fname'].'  '.$row['mname'].'  '.$row['lname'];?></h4>
                              <h6 class="text-muted">parent of</h6>
                              <div class="user-Location"><?php echo $rowstud['fname'].'  '.$rowstud['lname'];?></div>
                              <div class="about-text">We are proud to teach your children!!!.</div>
                        ...
                        <div class="tab-pane fade show active" id="per_details_tab">
                           <div class="row">
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                       ...
                                       <div class="row">
                                          ...
                                          <p class="col-sm-9"><?php echo $row['fname'].'  '.$row['mname'].'  '.$row['lname'];?></p>
                                       </div>
                                       <div class="row">
                                       ...
                                       <div class="row">
                                          <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Sex</p>
                                          <p class="col-sm-9"><?php echo $row['sex'];?></p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="card ">
                                 <div class="card-body">
                                    <h5 class="card-title d-flex justify-content-between">
                                       <span>Your student subjects</span>
                                    </h5>
                                       ...
                                       <?php
                                          if(isset($_POST['submit']))
                                          {
                                             ...
                                             $imagetempname=$_FILES['img']['tmp_name'];
                                                $sqlchange="UPDATE `parent` SET `password`='$newpassword' WHERE `id`='$id';";
                                                $resultchange=mysqli_query($con,$sqlchange);
                                                if($_FILES['img']['name'] != ''){
                                                $sqlchangeimg="UPDATE `parent` SET `img`='$imagename' WHERE `id`='$id';";
