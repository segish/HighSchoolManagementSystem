...
<html lang="en" dir="ltr">
    ...
    <link rel="stylesheet" href="style.css">
        ...
        <div class="main" style="overflow: visible;">
         <div class="page-wrapper margin" style="margin-top: 50px;">
                                       ...
                                       <div class="col-md-10 col-lg-12">
                                          ...
                                          if(isset($_POST['savechange']))
                                          {
                                             ...
                                             $imagetempname=$_FILES['img']['tmp_name'];
                                                $sqlchange="UPDATE `admin` SET `password`='$newpassword' WHERE `id`='$id';";
                                                $resultchange=mysqli_query($con,$sqlchange);
                                                if($_FILES['img']['name'] != ''){
                                                $sqlchangeimg="UPDATE `admin` SET `img`='$imagename' WHERE `id`='$id';";
